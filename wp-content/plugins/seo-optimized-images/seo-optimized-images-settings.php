...
<div class="wrap settings-wrap" id="page-settings">
	...
	<div id="section_support" class = "postbox">
        ...
        <p><span class="description"><?php echo sprintf(__('2. If you like our plugin and support than kindly share your <a href = "https://wordpress.org/support/view/plugin-reviews/seo-optimized-images" target = "_blank"> feedback </a> Your feedback is valuable. ','seo-optimized-images')); ?>
        </span></p>
...
<div class="row" style="margin-left:10px;background: #f7f7f7;padding-top: 10px;padding-bottom: 70px;">
	...
	<p><?php echo sprintf(__('The package have a support for <b>Featured Images, Custom Post Images and Custom Rules.</b> The price of this package is <b>$59</b>','seo-optimized-images')); ?></p></li> 
		<li class="ui-corner-left"><h3><?php _e('SEO - Business with WooCommerce package','seo-optimized-images') ?></h3>
		<p><?php echo sprintf(__('The package have a support for <b>WooCommerce Images, Featured Images, Custom Post Images and Custom Rules.</b> The price of this package is <b>$79</b>','seo-optimized-images')); ?></p>
		</li></ul>
...
<p><?php echo sprintf(__('If you are interested then you can buy the plugin <a href="http://webriti.com/seo-optimized-images/" target="_blank">here</a>. Once the purchase process gets complete, <a href="http://webriti.com/amember/login/index" target="_blank">login</a> to your account and download the latest package.','seo-optimized-images')); ?></p>
